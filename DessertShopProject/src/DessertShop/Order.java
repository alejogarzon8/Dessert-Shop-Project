		...
		if (item instanceof Candy) {
			...
			for (DessertItem dessert_item : order) {
				if (dessert_item instanceof Candy) {
					...
					if (new_candy.getPricePerPound() == old_candy.getPricePerPound()
							&& old_candy.getName().equals(new_candy.getName())) {
			...
			for (DessertItem dessert_item : order) {
				if (dessert_item instanceof Cookie) {
					if (dessert_item instanceof Cookie) {
						...
						if (new_cookie.getPricePerDozen() == old_cookie.getPricePerDozen()
								&& old_cookie.getName().equals(new_cookie.getName())) {
